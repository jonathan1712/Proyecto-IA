...
class Normalizador:
    ...
    def normalizar(self):
        """ normalizar
        Para cada fila del data_set se aplica la funcion zscore.
        ...
        for i in range(columnas):
            ...
            # redonde los datos a dos digitos
    ...
    def zcore(self, columna):
        """ zscore
        Aplica la funcion zscore de stats a una columna (lista)
        """
    ...
    def clasificar_columnas(self):
        """ clasificar_columnas
        Toma las columnas ya normalizadas y las clasifica segun
    ...
    def generar_rangos(self, media, minimo, maximo, rangos):
        """ generar_rangos
        Dado los valores flotantes de media, minimo, maximo de una columna,
        genera un cantidad n de rangos, para ello se calcula la distancia
        del minimo al maximo y ese es el intervalo de cada rango.
        Hace distincion entre limite del tipo "<x, >x" y a <= x < b
        """
    ...
    def clasificar_columna(self, columna, etiquetas):
        ...
        etiquetas que se generaron para la misma segun el numero de
        rangos solicitados.
        """
    ...
    def evaluar_limite(self, tipo, expresion, numero):
        ...
        retorna True o False dependiendo de la evaluacion.
        """
