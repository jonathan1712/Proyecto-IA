...
def test_crear_bootstrapped():
    ...
    # Se prueba que el bootstrapped no esta vacio
...
def test_crear_forest():
    ...
    df = pd.DataFrame({'area': are,
                       ...
                       'radio': rad,
                       'diagnosis': dia})
    # 10 = Numero de cantidad de arboles
    random_forest = Random_Forest(10, df)
    random_forest.crear_forest()

    # Se prueba que el arreglo de arboles no esta vacio
