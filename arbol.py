...
class Arbol:
    ...
    def crear_arbol(self, filas):
        """crear_arbol
        Inicia el proceso recursivo de creacian con la raiz
        """
    ...
    def generar_columnas(self, cantidad, atributos):
        """generar_columnas
        Genera una lista de tamano n, con nameros random
    ...
    def get_prediccion(self, filas):
        """ get_prediccion
        Retorna True si la prediccian de un grupo de filas es 1 sino False
        """
    ...
    def get_entropia_raiz(self, filas):
        """ get_entropia_raiz
        Obtiene la entropaa de un conjunto de filas
        """
    ...
    def entropia(self, p, n):
        """ entropia
        Calculo de la entropia segan la farmula del libro
        """
    ...
    def ganancia_informacion(self, v_unicos, datos_columnas, col, entropia):
        ...
        Retorna la diferencia entre la entropaa del nodo padre
    ...
    def evaluar_fila(self, fila):
        """ evaluar_fila
        Inicia el proceso recursivo de evaluacian de una funcian
        """
    ...
    def evaluar_fila_aux(self, nodo, fila):
        """ evaluar_fila_aux
        Funcian donde se evalua a profundidad una fila en el arbol.
